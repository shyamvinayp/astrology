...
@section('content_header')
    @include('partials.content-header', [
        'pageHeadTitle' => 'Edit Scam Center',
        ])
@endsection
...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header"><h4>Edit Scam Center</h4></div>
                    <div class="card-body">
                        {!! Form::model($scamcenter, ['url'=>route('scamcenters.update',$scamcenter->id), 'id' => 'telecom-main-form', 'class' => 'dirtyforms']) !!}
