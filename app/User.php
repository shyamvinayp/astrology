...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password','fname', 'mname', 'lname', 'type', 'address','address_2', 'country_id','city', 'zip', 'state',
        'amount', 'currency', 'image', 'status', 'education', 'category_id','extension','mobile','	alternate_phone', 'sex', 'dob','image','status'
    ];
